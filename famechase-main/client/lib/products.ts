...
function normalizeDownloadText(input: string): string {
  ...
  const replacements: Array<[RegExp, string]> = [
    ...
    [/\u1F6F0|\u1F680/g, "*"], // rocket
    [/\u1F4B0/g, "$"], // money bag
    [/\p{Emoji_Presentation}|\p{Extended_Pictographic}/gu, ""], // strip remaining emojis
  ];
...
• अप��े प्रोडक्ट्स/सर्��िस लॉन्च करें
...
2) इन्फ्लुएंसर कोलेबोरेशन एग्रीमेंट (Project/Barter/Hybrid)
...
5. कंटेंट गाइडलाइंस
• ब्रांड गाइडलाइंस, FTC डिस्क्लोज़र, और एप्रूवल प्रक्रिया का पालन
...
3. गोपनीयता
• दरें, रणनीति, अप्रकाशित प्रोडक्ट – गोपनीय
