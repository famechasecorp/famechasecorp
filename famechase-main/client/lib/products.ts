...
// Normalize problematic symbols/emojis to ASCII-safe equivalents for PDF text rendering
function normalizeDownloadText(input: string): string {
  if (!input) return "";
  ...
  const replacements: Array<[RegExp, string]> = [
    ...
    [/\u20B9/g, "INR "], // ₹ → INR
    [/\u2605|\u2728/g, "*"], // stars / sparkles
    [/\u1F4D6|\u1F4D5|\u1F4DA/g, "#"], // book emojis
    [/\u1F6F0|\u1F680/g, "*"], // rocket
    [/\u1F4B0/g, "$"], // money bag
    [/[\uD800-\uDBFF][\uDC00-\uDFFF]/g, ""], // strip emoji pairs (surrogate pairs)
    [/[\u1F300-\u1F9FF]|[\u2600-\u27BF]/g, ""], // common emoji/symbol ranges
  ];
  ...
  for (const [pattern, replacement] of replacements) {
    try {
      ...
      // Skip patterns that fail in older environments
      console.warn("Skipped normalization pattern:", e);
    }
  }
  return out;
}
...
ईमे��: ${userEmail}
न���च: ${userNiche}
प��राथमिक प्लेटफॉर्म: ${userPlatform}
...
💰 सुझावित दरें (आपके ऑडिय��स के आधार पर):
📸 पो्ट दरें: ₹200 - ₹1,000
📱 स्टोरी दरें: ₹100 - ₹500
🎥 रील दरें: ₹500 - ₹2,000
...
स��शल मीडिया: [आपके सभी सोशल प्लेटफॉ��्म]

🤝 कोलैबोरेशन टर्म्स:
• उपयोग अधिकार: [स्पेसिफाई करें]
• एक्सक्लूसिविटी: [यदि ���ोई हो]
...
✅ ऑडियंस डेमो��्राफिक्स रिप��र्ट
✅ पफ���र्मेंस मेट्रिक्स और एनालि��िक्स
...
5. प्रोफेशनल ड���ज़ाइन में कन्��र्ट करें

🎨 डिज़ान टिप्स:
• क्लीन औ�� प्रोफेशनल लेआउ
• ब्रांड कलर्��� का उपयोग
• हाई-क्वालिटी इमेज और ग्राफिकस
• रीडेबल फॉन्ट्स और क्लियर हेडिंग्��
...
function generateEmailTemplatesContent(
  ...
  if (language === "hindi") {
    return `📧 30+ ब्रांड आउटरीच ई���ेल टेम्प्लेट्स

🎯 टेम्प्ले 1: प्रारंभिक संपर्क (कोल्ड ���उटरीच)
...
Recently मैंने [competitor brand] के साथ work कि��ा और उस post को [specific results] मि��े।
...
विष���: Re: Collaboration proposal - Let's find a win-win

Hi [Contact Name],

आपके proposal के ��िए thank you! मैं definitely interested हूं।

Considering my engagement rates और audience quality, क्य��� हम rate को slightly adjust कर सकते हैं? मैं ₹[your counter] suggest क��ू���गा because:
...
---
 ...
 टेम्प्लेट 5: परफ��र्मेंस रिपोर्ट
...
💝 टेम्���्लेट 6: लॉन्ग-टर्म प���र्टनरशिप प्रपज़ल
विषय: Long-term Partnership Proposal - ${userName} x [Brand]

Dear [Decision Maker],

हमारे successful collaboration के बाद, ��ैं एक long-term partnership propose करना चाहूंगा।
...
🎯 ${userNiche} के लिए ${userPlatform} कंटेंट प्ल���न
...
• अपनी ब्रांड आइड��ंटिटी डिफाइन करें
• 30 दिन का कंटेंट कलंडर बनाएं
• आपके टार्गेट ऑडियंस को समझें
• ���ंगेजमेंट बढ़ाने के लिए 10 स््रैटेजी
• अपने बेस्ट पोस्ट्स को एनालाइज करें
• भारतीय अवसरों और ट्रेंड्स प��� रिसर्च करें
...
✅ साप्ताहिक एनालि��िक्स रिव्यू
✅ मासिक कंटेंट प्लानिंग
 इंडस्ट्री नेटवर्किंग और कोलैबोरेशन
✅ ब्रांड और मार्केि��ग आउ���रीच
✅ ��म्युनिटी एगेजमेंट र रेस्पॉन्स

📉 मेट्रिक्स ट्रैकिं��:
• फॉलोअ�� ग्रोथ रेट: ____%
• एंगेमेंट रेट: ____%
• मासक रीच: ____
• वेबसाइट विजिटर्स: ____
• ब्रांड इंक्वायर��: ____
• मासिक आय: ₹____

🎆 अपेक्षित ��रिणाम (90 दिन):
• फॉलोअर ���्रोथ: 50-150%
...
• भारती मार्केट क��� लिए कंटेंट लोकलाइज करें
...
function generateHashtagGuideContent(
  ...
  if (language === "hindi") {
    return `#️⃣ हैशटैग रिस���्च मास्टर गाइड

${userNiche} क्रिएटर्��� े लि�� ${userPlatform} हैशटैग रणनीति

🔍 हैशटै�� की बुनियादी बातें:
• हैशटै व्यू��� को बढ़ात हैं (30x तक बढ़ कते हैं)
• वे आपके कंटेंट को टार्गे�� ऑडियंस तक पहुंचा���े हैं
...
✅ ट्���े���डिंग hashtags पर नजर रखें
...
📉 हैशट���ग परफॉर्मेंस ट्रैकिंग:
• Reach और impressions में वृद्धि
• Profile visits में ब���़ोतरी
• Hashtag-specific engagement
• New followers from hashtags
• Comments और saves में वृद्धि

🎆 प्रो टिप्स:
1. हर दिन 2-3 ���ए hashtags try करें
2. अपने निच के top influencers ���ो research ���रें
...
• स्टोरी सीर��ज (3-5 slides): ₹${rates.story} + 40%
...
• Twitter ���ोस्ट/थ्रेड: ₹${Math.floor(parseInt(rates.story.split("-")[0]) * 0.5)}-${Math.floor(parseInt(rates.story.split("-")[1]) * 0.8)}
• LinkedIn पोस्ट: ₹${rates.story}

📦 कैम्पेन पैकेजेज:

🎆 बेसिक कैम्पेन पकेज: ₹${rates.campaign}
• 1 Instagram ���ीड पोस्ट
• 3-4 इ���्टाग्राम स���टोरीज
• 1 इंस्टाग्�� री
• बिहाइंड-द-स��न content
• वी��ली एनालिटिक्स रिपोर्ट

🚀 प्रीमियम कैम्पेन पैकेज: ₹${parseInt(rates.campaign.split("-")[1]) * 2}
• 2 Instagram फीड पोस्ट्स
• 6-8 इंस्टाग्रा��� स्टोरीज
• 2 इंस्टाग्राम रील्स
...
• ब्��ांड वैल्यूज और मिशन के साथ alignment
...
• क��टेंट स्टार्ट के बाद: नो रि���ंड
...
🎆 धन्यवद!
मैं आपक��� ब्रांड के साथ का�� करने के लिए उ���्साहित हूं और आपे लक्ष्यों को पूरा करने में मदद करने के लिए तैयार हूं!`;
  }
...
यह पैक आपको ब्रांड डील्स, कंटेंट निर्��ाण और UGC लाइसेंसि��ग क�� लिए कानूनी रूप से मजबूत, सरल और उपयोगी कॉन्ट्रैक्ट देता है। भुगतान, डिलीवेरेबल्स, उपयोग-अध��कार, टाइमलाइन और कैंसलेशन जैसी सभी ज़रूरी बातें शामिल हैं।

शामिल टेम्पलेट्स:
1) स्पॉन्सर्ड कंटेंट एग्रीमेंट (Paid Promotion)
2) इ���्फ्लुएंसर कोलेबोरेशन एग्रीमेंट (Project/Barter/Hybrid)
3) UGC लाइसेंसिंग एग्रीमेंट (Usage & Ownership)

त्वरित उपयोग निर्देश:
• हर सेक्शन ध्यान से पढ़ें और आवश्यकतानुसार एडिट करें
• एग्रीमेंट को PDF में शेयर करें और ई-साइन लें
• भुगतान शर्तें ��हले से क्लियर रखें (एडवांस + माइलस्टोन)

— — —
1) स्पॉन्सर्ड कंटेंट ���ग्रीमेंट

पक्षक���र: ब्रांड (क्लाइंट) और क्रिएटर (सेवा प्रदाता)

1. सेवाएँ व डिलीवेरेबल्स
• प्लेटफ़ॉर्म: Instagram/YouTube/LinkedIn आदि
• डिलीवेरेबल्स: 1 रील + 1 स्टोर��� + 1 स्टेटिक पो��्ट
• कंटेंट सबमिशन: पह��ी ड्राफ्ट 5 कार्य दिवस में
• संशोधन: अधिकतम 2 राउंड, हर अतिरिक्त राउंड ₹1,500

2. भुगतान शर्तें
• कुल फीस: ₹XX,XXX + लागू कर
• भुगतान: 50% एडवांस, 50% फाइनल डिलीवरी पर
• लेट फीस: देरी पर प्रति सप्ताह 5% पेनल्टी
• चालान: क्रिएटर द्वारा मेल प�� भेजा जाएगा

3. उपयोग-अधिकार (Usage Rights)
• ब्र���ंड को 12 महीनों तक ऑर्गेनिक उपयोग अधिकार
• पेड ऐड/व्हाइटलिस्टिंग हेतु लिखित अनुमति आवश्��क और अलग शुल्क
• मूल कंटेंट का कॉपीराइट क्रिएटर के पास रहेगा

4. टाइमलाइन
• ब्रिफ़ प्राप्ति के 48 घंटों में कॉन्सेप्ट
• पहली ड्राफ्��� 5 दिनो�� में, अंतिम डिलीवरी 7–10 दिन��ं में

5. कंटेंट गाइडलाइंस
• ब्रांड गाइडलाइंस, FTC ���िस्क्लोज़र, और एप्रूवल प्रक्रिया का पालन
• अनैतिक/भ्रामक दावों पर ब्रांड जिम्मेदार होगा

6. एक्सक्लूसिविटी
• उसी प्रोडक्ट कैटेगरी में 30 दिनों तक कोई प्रतिस्पर्धी प्रमोशन नहीं
• एक्सक्लूसिविटी बढ़ाने पर ��तिरिक्त शुल्क लागू

7. रद्दीकरण नीति
• प्रोजेक्ट शुरू होने से पहले: पूर्ण रिफंड
��� स्क्रि���्ट/शूट शु���ू होने के बाद: 50% रद्दीकरण शुल्क
• फाइनल डिलीवरी के बाद: कोई रिफंड नहीं

8. गोपनीयता व डेटा
• ब्रिफ़, रेट और निजी डेटा गोपनीय र���ेगा

9. दायित्व सीमitation
• अप्र���्यक्ष/परिणामी हानि के लिए कोई जिम्मेदारी नहीं

10. शा���न कानून
• भारत के लागू कानून; विवाद का समाधान मध्यस्थता से
...
— — —
2) इन्फ्लुएंसर कोलेबोरेशन एग्रीमेंट

1. स्कोप
• अभियान उद्देश्यों, मैट्रिक्स और कंटे��ट फॉर्मैट्स का स्पष्ट उल्लेख

2. भुगतान/बार्टर
• Paid: ₹XX,XXX + कर
• Barter: उत्पाद मूल्य ₹X,XXX; डिलीवरी ��े 3 दिनों के भीतर
• Hybrid: 30% नकद + उत्पाद

3. रिपोर्टिंग
• पोस्ट-परफ़ॉर्मेंस: रीच, व्यूज़, CTR, सेव्स, लिंक-क्लिक्स

4. IP और उपयोग
• 6–12 महीने तक डिजिटल उपयो��� अधिकार; टीवी/OOH अलग शुल्��

5. फोर्स मेज्योर
• अप्रत्याशित परिस्थितियों में टाइमलाइन बढ़ाई जा सकती है

हस्ताक्षर: दोनों पक्षों द्वारा

— — —
3) UGC लाइसेंसिंग एग्रीमेंट

1. लाइसेंस प्रकार
• नॉन-एक्सक्लूसिव/एक्सक्लूसिव (शुल्क के अनुसार)
• अवधि: 12–24 महीने
• क्षेत्र: भ���रत/ग्लोबल

2. अन��मत उपयोग
• वेबसाइट, सोशल, ईमेल, पेड ऐड्स (यदि सहमति हो)
• एडिट/क्रॉप/रीसाइज़ की अनुमति, गलत प्रस्तु���ि नहीं
...
4. क्रेडिट
• जहां संभव हो, “Content by <Creator Name>”

5. समाप्ति
• शर्त उल्लंघन पर 7-दिन की लिखित नोटिस के बाद समाप्ति

सुझाव (Monetization):
• बंडल पैक ऑफ़र करें (3 रील + 5 स्टोरी = पैकेज प्राइस)
• लाइसेंस अवधि/एक्सक्लूसिविटी के अनुसार शुल्क बढ़ाएँ
• तेजी से डिलीवरी (48h) पर ‘रश फ़ीस’ जोड़ें`;
  }

  return `📄 Creator Contract Template Pack

This pack includes legally-sound, revenue-focused templates for sponsored posts, collaborations, and UGC licensing. Every section is written to protect your income and clarify deliverables, timelines, and usage rights.

Included templates:
1) Sponsored Content Agreement (Paid Promotion)
2) Influencer Collaboration Agreement (Project/Barter/Hybrid)
3) UGC Licensing Agreement (Usage & Ownership)

Quick usage:
• Review and edit terms as needed
• Share as PDF and collect e-signatures
• Always clarify payment (advance + milestone) up front

— — —
1) Sponsored Content Agreement

Parties: Brand (Client) and Creator (Service Provider)

1. Services & Deliverables
• Platform: Instagram/YouTube/LinkedIn etc.
�� Deliverables: 1 Reel + 1 Story + 1 Static Post
• First draft in 5 business days; up to 2 revisions (extra rounds ₹1,500 each)

2. Payment
• Total fee: ₹XX,XXX + applicable taxes
• 50% advance, 50% on final delivery
• Late fee: 5% per week after due date
• Invoice raised by Creator via email

3. Usage Rights
• 12 months organic usage for the Brand
• Paid ads/whitelisting requires written consent and separate fee
• Copyright remains with the Creator

4. Timeline
• Concept within 48 hours of receiving brief
• First draft in 5 days; final delivery in 7–10 days

5. Content Guidelines
• Follow brand guidelines and disclosure laws (FTC/ASCI)
• Brand is responsible for claims about its products

6. Exclusivity
• 30-day category exclusivity; extended exclusivity = additional fee

7. Cancellation
• Before work starts: full refund
• After scripting/shoot starts: 50% cancellation fee
• After final delivery: no refund

8. Confidentiality & Data
• Briefs, rates, and personal info stay confidential

9. Limitation of Liability
• No liability for indirect or consequential damages

10. Governing Law
• Laws of India; disputes via arbitration
...
— — —
2) Influencer Collaboration Agreement

1. Scope
• Campaign goals, KPIs, and formats clearly defined

2. Compensation/Barter
• Paid: ₹XX,XXX + taxes
• Barter: product value ₹X,XXX; delivery within 3 days of content
• Hybrid: 30% cash + product

3. Reporting
• Post-campaign metrics: reach, views, CTR, saves, link-clicks

4. IP & Usage
• 6–12 months digital usage; TV/OOH require separate license

5. Force Majeure
• Timelines may extend during unforeseen events

Signed by both parties

— — —
3) UGC Licensing Agreement

1. License Type
• Non-exclusive/Exclusive (priced accordingly)
• Term: 12–24 months
• Territory: India/Global

2. Permitted Uses
• Website, social, email, paid ads (if agreed)
��� Edits/resize allowed; no misleading representation

3. Payment
• ₹X,XXX–₹XX,XXX per creative; bundle discounts available
• Net 7 days upon invoice

4. Credit
• Where possible: “Content by <Creator Name>”

5. Termination
• 7-day written cure notice for material breach

Monetization tips:
• Offer bundles (3 reels + 5 stories = package price)
• Charge more for license duration and exclusivity
• Add a ‘rush fee’ for 48h delivery`;
}
...
function generateViralReelIdeasContent(
  ...
  if (language === "hindi") {
    return `🎬 50+ वाय���ल रील आइडिया�� गाइ���
...
15. "[न���च] की हिस्ट्री - 60 सेकंड मे��"
16. "[निच] में पैसा कमाने के तरीके"
17. "मैं कैसे [स्पे���िफिक रिजल्ट] पाया"
18. "[���िच] में मेरी टॉप 3 टिप्स"
19. "���्या करें औ��� क्या न कर��ं [निच] में"
...
33. "[निच] के टाइप्स ���फ पीप��"
34. "मेरी [निच] ��र्नी - कॉमेडी वर्���न"
35. "[निच] ��े स्ट्र��ल्स"
36. "क्ा होता है जब मैं [निच activity] करता हूं"
37. "[निच] वाले की जि���दगी"
38. "[िच] के मैम्स"
39. "दोस्त vs म��ं [निच] मे��"
40. "पेरेंट्स vs मेरा [निच] ���ैशन"
41. "[निच] करते समय मूड्स"
42. "[नच] के बारे मे पेरेंट्स �� रिएक्शन"
43. "[निच] वाले के पास कैसे ट���इम मैनेज होता है"
44. "[निच] ���ाले रात को क्या रत ह��ं"
45. "[निच] वाले की शॉपिंग"

💡 ट्रेंड रील्स (5 आइडियाज):
46. "इस रील को आपके [नच] दोस्त क��� भेजो"
...
🎬 प्रोडक्शन टिप्स:
✅ वर्टिकल फॉ��्मेट (9:16)
✅ अच्छी लाइटिंग
✅ क्लियर ऑियो
✅ ��ई कांटेक्ट
✅ ���्रेम में फेस क्लियर दिखे
✅ ��्रिकेंट कट्स/ट्रांजिशन
✅ On-screen text
...
function generateMusicGuideContent(
  ...
  if (language === "hindi") {
    return `🎵 ��्यूजिक & सांड सेलेक्शन मास्टर गाइड
...
• 1-3 मि���ट videos के लिए varied tempo
• Background music volume: 20-30%
...
• मजूत हुक (hook) ���ा इस्तेमा करें
• सवाल पू��ें या शॉकिंग statement दें
• तेज और पैतरे movement/action द��खाएं
...
• ट्रेंड��ग म्यूजिक का इस्तेम��ल करें
...
📊 एनालिटिक्स और मेट्रिक्स ट्रैक��ंग:

�� की मेट्रिक्स पर फोकस रें:
• विय��� रेट (70%+ target करें)
• ���वरेज विय��� ड्यूे���न (complete views)
• रीच और इम��प्रेशन्स ग्र���थ
• शेयर्स और saves (strong engagement signals)
• कमंट रेस्पॉन्स रेट

💡 प्रो ट��्स और तकनीकें:

1. लूप वीडिो और pattern interrupts
2. मल्टि-ल���यर्ड storytelling
3. विजुअल ऑप्टिक illusions
4. फेस focus औ��� eye contact
5. कॉन्ट्रास्टिंग विजुअ��� elements

��� आद्वांस एल्गो���िदम हैक्स:
...
• गोल्न आवर (first 2 hours) म���ं एक���टिव रहें
• Cross-promotion े initial boost लें

🔄 ������टेंट रिपरपाजिंग और adaptation:
...
• अप���े आप से दर लगने वाले conversations
• हिंदी-इं��्लिश mix (Indian audience के लिए perfect)
...
🎆 क्या किया ठीक:
• लड़किय���ं के रील प्रोब्लम् address कए
...
📈 सफलता के आंकडे:
• 35M+ यूट्यूब सब्स��्राइबरस
• 12M+ इंस्टाग्राम फॉलो��र्स
...
• Fitness expertise के ���ाथ entertainment
...
2️⃣ कॉ���्सिस्टेंसी (Consistency):
• Regular posting schedule maintain करते ��ैं
...
4️⃣ वैल्य क्रिएश��� (Value Creation):
• Entertainment + education mix
• Actionable tips और advice
• Problem-solving content

5��⃣ एंगेजमेंट (Community Engagement):
...
🎆 याद रखें:
“सफ���ता रातोंरात नह��ं आती। ये सभी creators ने वर्षों की मेहनत, लगन और निरंतर सीखने के बाद य�� मुकाम हासिल किया है।”`;
  }
...
${userName} - ${userNiche} ���े लिए 25+ ��्रोवन ईमेल टेम्प्लेट्स
...
• मैं authentic ���र engaging content बनाने में specialize करता हूं
...
क्या आप ��क quick call schedule कर सकते है��� collaboration possibilities discuss करने के लिए?
...
ैंने पिछले सप्ताह ��पको collaboration के बारे में email भेजा था।
...
क्���ा हम इस week एक quick 15-minute call schedule क��� सकते हैं?
...
विष��: ${userName} - Detailed Partnership Proposal for [Brand]

Dear [Brand Name] Marketing Team,

आपकी interest के लिए धन्यवाद! ��हां मेरा detailed collaboration proposal है:
...
आपके proposal के लिए thank you! म���ं definitely collaboration के लिए excited हूं।

मेरे engagement rates और audience quality को considering करते हुए, क्या हम rate को slightly adjust कर सकते हैं?

मैं ₹[your counter] suggest करूंगा क��योंकि:
...
🎁 BONUS OFFERINGS:
मैं इस collaboration में extra value add ��रने के लिए तैयार हूं:
• Extended story highlights (30 days)
• User-generated content encouragement
• Cross-platform promotion at no extra cost
• Post-campaign performance analysis

मुझे एक mutually beneficial partnership नाने में believe ���ै। ���पके thoughts?
...
• Engagement Rate: [%] (Industry average ��े [x]% बेहतर)
...
यह partnership आपके brand को consistent visibility और authentic audience connection provide ��रेगी।
...
आपके upcoming [product/event name] launch के बारे म��ं सुना है। Congratulations!
...
मे���ी audience आपके target market के साथ perfectly align करती है और launch success में significant contribution कर सकती ��ै।
...
function generateYouTubeSEOContent(
  ...
  if (language === "hindi") {
    return `🎬 य���ट्यूब SEO ऑप्टिमाइजेशन कम्प्ीट गाइड
...
• Emotional trigger words ("गुप्त", "जरूरी", "नहीं जा���ते")
...
"इस वीडियो में आप सीखेंगे [specific benefit] जो आप���ी [niche problem] solve करेगा।"
...
• Comments engagement के ���िए controversy नहीं, curiosity
• Subscribers conversion के लिए clear CTAs

🎬 CONTENT OPTIMIZATION:
• Introduction में value promise करें
• 2-3 minutes के ���ंदर main point start करें
...
• Festival ���र events के around content plan करें
...
function generateYouTubeMonetizationContent(
  ...
  if (language === "hindi") {
    return `💰 यूट्यूब मोनेटाइजेशन कम्प्लीट ब्लूपरि��ट
...
• Practical exercises include ��रें
...
function generateThumbnailTemplatesContent(
  ...
  if (language === "hindi") {
    return `🎨 वायरल थंबनेल टेम्प्लेट्स & साइक���लॉजी गाइड
...
• FOMO trigger करें ("आखिरी चांस", "��ेवल आज")
...
• Intriguing text ("क्य�� आप जानते हैं?")
...
function generateFacebookAlgorithmContent(
  ...
  if (language === "hindi") {
    return `📱 फेसबुक एल्ग���रिदम सी्रेट्स 2024
...
• Questions पूछे�� जो detailed answers encourage करें
...
• Captions add क��े (80% video sound के बिना देखे जाते हैं)
• Square (1:1) ��ा vertical (9:16) formats prefer करें
...
क्या आपक��� साथ भी कुछ ऐसा हुआ है? Comments में share करें!"
...
अगली बार जब आप [related activity] देखें, ���ाद र��िएगा यह सब!"
...
"[Number] तर��के जो [specific problem] solve करते हैं:
...
• "कभी सोचा ै कि [common situation] क्य���ं होत है?"
...
• "सबसे बड़ी ग��ती जो [target audience] क���ती है..."

🎯 Story Hooks:
• "कल रात मुझे एक call आया..."
• "3 साल प��ले मैं [situation] में था..."
• "आज मरे साथ कुछ अजीब हुआ..."

📊 POSTING SCHEDULE OPTIMIZATION:

⏰ TIMING STRATEGY:
��ोमवार: Motivational content (9 AM)
...
• पुराने popular posts को update ��रें
...
• Exclusive bonuses provide क��ें
...
🔧 TOOL RECOMMENDATIONS:
• Genuinely use क���ें जो tools recommend करते हैं
• Detailed reviews provide करें
• Comparison posts create करें
• Discount codes share क���ें (if available)
...
function generateFacebookCalendarContent(
  ...
  if (language === "hindi") {
    return ` फेसबुक कंटेंट ���ैलेंडर टेम��प्लेट्स
...
Example posts:
• "नया ह��्ता, नई शुरुआत! आज आप क्या achieve करने वाले हैं?"
...
Example posts:
• "[Niche] में beginners के लि��� complete guide"
...
Example posts:
• "आज मैं share करूंग��� मेरी journey का एक interesting part"
• "Saturday storytime: कैस��� म���ंने [specific challenge] overcome किया"
...
Example posts:
• "इस week की biggest learning क��या रही?"
...
function generateMediaKitDesignsContent(
  ...
  if (language === "hindi") {
    return `📱 10 प्र��फेशनल मीडिया किट डिजाइन टेम्प्ल���ट्स
...
• पह��ी संख्या negotiate के लिए anchor बन जाती है
• Example: अगर आप ₹10K चाहते ���ैं, तो ₹13K quote करें
...
• "मेरे पास इस month सिर्फ 2 collaboration slots available ���ैं"
• "Next month से मेरे rates 25% increase हो रहे हैं"
• Limited availability create करें

4️⃣ SOCIAL PROOF LEVERAGE:
• "XYZ brand के सा��� similar collaboration में हमें 40% ROI मिला था"
...
You: "मैं appreciate करत�� हू आपक transparency�� ₹5K में हम एक story series create कर सकते हैं, लेकिन complete post integration ���े लिए मेरा standard rate ₹10K है क्योंकि इसमें professional photography, content creation, और guaranteed engagement included है। क्या हम middle ground find कर ���कते हैं?"
...
You: "मैं quality के लिए committed हूं! मेरे standard package में 2 major revisions included हैं, जो usually sufficient होती हैं क्योंकि मैं detailed brief लेता ह���ं। Additional revisions के लिए ₹500 per revision charge ोगा to maintain quality standards।"
...
✅ Response: "Absolutely! Market में different price points होते ��ैं। मेरी rates म���री [specific strengths] को reflect करती हैं। आ���ए results के basis पर compare करते हैं - ROI, engagement quality, और brand alignment।"

❌ "Free product क�� बदले में post कर दो"
✅ Response: "Product collaboration मैं definitely consider कर��ा हूं, लेकिन product value के अनुपात ��ें। ₹[product value] के product के लिए story mention appropriate होगा। Full post के िए हमें monetary compensation भी चाहिए��"
...
🎯 COMMUNICATION STYLE:
• Professional लेकिन friendly tone maintain कर��ं
...
function generateBrandContractContent(
  ...
  if (language === "hindi") {
    return `📕 ब्रांड पार्टनरशिप कॉन्ट्रैक्ट किट

यह किट मास्टर सर्विस एग्रीमेंट (MSA) + स्ट���टमेंट ऑफ़ वर्क (SOW) का साफ़ फ़ॉर्मेट देती है, ताकि रेट, ��्कोप और डेडलाइन्स बिल्कुल क्लियर हों और पेमेंट समय पर मिले।

A) मास्टर सर्विस एग्रीमेंट (MSA)
1. संबंध क��� प्रकृति
• क्रिएटर स्वतंत्र ठेकेदार है; रोजगार संबंध नहीं

2. भुगतान व कर
• सभी फीस + लागू कर ब्रांड द्वारा देय
• पेमेंट शेड्यूल: एडवांस/माइलस्टोन/फाइनल

3. गोपनीयता
• दरें, रणनीति, अप्रकाशित प्रोड��्ट – गोपनीय

4. बौद्धिक संपदा
• डिफ़ॉल्ट रूप से कंटेंट का कॉपीराइट क्रिएटर के पास
• व्यावसायिक/पेड ऐड्स उपयोग हेतु अलग लाइसेंस

5. गैर-प्रलोभन/एक्सक्लूसिविटी
• क��टेगरी-एक्सक्लूसिविटी केवल लिखित सहमति पर

6. दायित्व सी��itation
• अप्रत्यक्ष/परिणामी क्षति के लिए कोई दायित्व नहीं

7. कान��न व विवाद समाधान
• भारत के कानून; मध���यस्थता द्वारा समाधान

B) स्टेटमेंट ऑफ़ वर्क (SOW)
1. स्कोप व डिलीवेरेबल्स
• प्लेटफ़ॉर्म/फॉर्मैट/कॉन्टेंट-काउंट स्पष्ट

2. टाइमलाइन
• ब्रिफ़ → ���्राफ्ट → रिविज़न → फाइनल डिलीवरी

3. अनुमोदन प्रक्रिया
��� अधिकतम 2–3 रिविज़न; अतिरिक्त रिविज़न पर शुल्क

4. उपयोग-अधिकार
• अवधि/क्षेत्र/माध्यम; पेड ऐड्स/व्हाइटलिस्टिंग अलग

5. भुगतान शर्तें
• उदाहरण: 40% एडवांस, 30% ड्रा���्ट अप्रूवल पर, 30% फाइनल डिलीवरी पर
• लेट फ़ीस: प्रति सप्ताह 5% (���दि देरी)

6. रिपोर्टिंग
• परफ़ॉर्मेंस मेट्रिक्स और इनसाइट्स साझा करना

Monetization सु��ाव:
• Retainer मॉडल: मासिक 4–6 कंटेंट पीस = फिक्स्ड फीस
• Upsell: Cutdowns, multi-language, paid-usage license
��� SLA आधारित ‘rush delivery’ शुल्क (48 घंटे)
• वार्षिक लाइसेंस पर 20–40% प्रीमियम`;
  }

  return `📕 Brand Partnership Contract Kit

A clean Master Service Agreement (MSA) + Statement of Work (SOW) bundle to make pricing, scope, and deadlines crystal clear—so payments arrive on time and rights are defined.

A) Master Service Agreement (MSA)
1. Relationship
• Creator acts as an independent contractor; not an employee

2. Payment & Taxes
• All fees + applicable taxes borne by Brand
• Payment schedule: advance/milestone/final

3. Confidentiality
• Rates, strategy, unreleased product info remain confidential

4. Intellectual Property
• By default, copyright remains with Creator
• Separate license for commercial/paid ads usage

5. Non-solicit/Exclusivity
• Category exclusivity only with written consent

6. Limitation of Liability
• No liability for indirect or consequential damages

7. Law & Dispute Resolution
• Laws of India; arbitration for disputes

B) Statement of Work (SOW)
1. Scope & Deliverables
��� Platforms, formats, and content count defined

2. Timeline
• Brief → Draft → Revisions → Final delivery

3. Approvals
• Up to 2–3 revisions; extra rounds billed additionally

4. Usage Rights
• Term/territory/media spelled out; whitelisting priced separately

5. Payment Terms
• Example: 40% advance, 30% on draft approval, 30% on final delivery
• Late fee: 5% per week after due date

6. Reporting
• Share performance metrics and insights post-campaign

Monetization playbook:
• Retainers: 4–6 assets/month for a fixed fee
• Upsell: cutdowns, multi-language variants, paid-usage license
• SLA ‘rush delivery’ for 48h turnarounds
• Annual licenses priced at 20–40% premium`;
}
...
यह किट आपको अपना खुद का ब्रांड/एजेंसी डेटाबेस बनाने, ट्रैक करन�� और मोनेटाइज़ करने का स्ट्रक्चर देता है।
...
🚀 SEO और हैटैग टूल्स:
• Hashtagify (FREE/Pro $29/month) - हैशटैग र���सर्च
• Display Purposes (FREE) - Instagram ह���शटैग
• All Hashtag (FREE) - हैशटैग जेनरेटर
• TubeBuddy (FREE/Pro $7.20/month) - YouTube SEO

📧 ईम��ल मार्केटिं:
• Mailchimp (FREE/Pro $10/month) - ईमेल ऑटोमेशन
• ConvertKit ($29/month) - क्रिएटर-फोकस्ड प�����ेटफॉर्म
...
• LastPass ($3/month) - ��ासवर्ड ��ैनेजर

🛠️ प्रो टप्स:
1. फ्री टूल्स से शुरू के��
2. एक बार में सिर्फ 1-2 पेड टूल्स आ��माएं
3. अपन बजट और जरूरतों के हिसाब से चुन��ं
4. महीने में ���क बार टूल्स की समीक्ष करें
5. ROI के लिए टूल्स के परफॉर्मेंस को ट्रैक ���रें

💰 बजट प्लानिंग:
• नए क्रिएटर: ₹0-2000/month
• ग्रोइंग क्रिएटर: ₹2000-8000/month
• प��रोफेशनल क्रिएट��: ₹8000-25000/month`;
  }
...
export async function downloadFile(
  ...
  try {
    ...
    const normalizedContent = normalizeDownloadText(content).replace(/\r\n/g, "\n");
    ...
    const finalFileName = /\.pdf$/i.test(trimmedName)
      ? trimmedName
      : `${trimmedName}.pdf`;
    ...
    console.warn("PDF generation/download failed, attempting plain text fallback.", err);
    try {
      const text = normalizeDownloadText(content);
      const trimmedName = fileName.trim();
      const txtName = /\.pdf$/i.test(trimmedName)
        ? trimmedName.replace(/\.pdf$/i, ".txt")
        : `${trimmedName}.txt`;
