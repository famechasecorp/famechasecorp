...
const translations = {
  ...
  hindi: {
    ...
    whatYouGet: {
      ...
      deliverables: {
        ...
        mediaKit: {
          ...
          description:
            "आपके आंकड़ों, ऑडियंस डेमोग्राफिक्स, और रेट कार्ड के साथ कस्टम-डिज़ाइ�� मीडिया किट टेम्प्लेट।",
    ...
    successStories: {
      ...
      stories: [
        ...
        },
        {
          ...
          avatar: "मी",
          testimonial:
            "ईमेल टेम्प्लेट्स गेम-चेंजर थे। मैंने उनका उपयोग करके 50 ब्रा��ड्स तक पहुंचने के लिए किया और 12 से रिस्पॉन्स मिला। अब मेरे पास निरंतर मासिक कोलैबोरेशन हैं।",
    ...
    footer: {
      description: "क्रिएटर्स को लाभदायक व्यवसाय ब��ाने में सशक्त बनाना",
...
If you were charged by mistake or have a billing concern, email mail@famechase.com within 7 days and we will review on a case-by-case basis.`,
  ...
  hindi: {
    about: {
      ...
      content: `FameChase इच्छुक इन्फ्लुएंसर्स और क्रिएटर्स को उनकी विकास क्षमता को अनलॉक करने में मदद करता ���ै। चाहे आप अभी शुरुआत कर र��े हों या अपने ऑडियंस को आय में बदलना चाह रहे हों, हम आपकी यात्रा को तेज़ करने के लिए व्यक्तिगत अंतर्दृष्टि, टूल्स, और डिजिटल उत्पाद प्रदान करते हैं।
...
आप mail@famechase.com पर ईमेल करके क���सी भी समय अपने डेटा को हटाने या सुधारने का अनुरोध कर सकते हैं।`,
    },
    terms: {
...
3. बौद्धिक संपदा:
प्रदान की गई सभी सामग्री, डिज़ाइन, और टूल्स FameChase की बौद्धिक ���ंपदा हैं। अ��धिकृत उपयोग निषिद्ध है।
