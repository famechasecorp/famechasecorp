...
const languages = {
  ...
  hindi: {
    ...
    questions: {
      ...
      niche: "���पका कंटें�� किस विषय पर है?",
      ...
      goals: "��पके अगले 6 महीने के मुख्य लक्ष्य क्या हैं? (अधिकत��� 3 चुनें)",
    ...
    options: {
      ...
      challenges: [
        ...
        "🧠 ग्रोथ और एंगेजमेंट: तेज़ बदलते ट्रेंड्स के स���थ प्रासंगिक बने रहना",
        ...
        "🥵 क्रिएटर वेलने��: बर्नआउ��� और कंटेंट थकान",
    ...
    freeResources: {
      title: "🎉 क्विज़ पूरा! यहाँ हैं आपके मुफ्त क्रिए���र संस���धन",
      subtitle:
...
export default function Quiz() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-2 md:gap-4">
            ...
            >
              ...
              <span className="hidden sm:inline">{language === "hindi" ? "होम पर लौटें" : "Back to Home"}</span>
              <span className="sm:hidden">{language === "hindi" ? "होम" : "Home"}</span>
            </Link>
            <select
              value={language}
              onChange={(e) =>
      ...
      <main
        ref={quizContentRef}
        className="container mx-auto px-2 md:px-4 pt-2 pb-60 min-h-[calc(100vh-88px)] flex flex-col md:justify-center"
      >
          ...
          <div className="bg-white border-2 border-gray-100 rounded-2xl px-4 md:px-8 pt-3 md:pt-6 pb-20 md:pb-28 shadow-xl backdrop-blur-sm min-h-[70vh] flex flex-col gap-3">
            ...
            {!isGenerating && (
              <>
                ...
                <div className="fixed left-0 right-0 bottom-0 z-40 bg-white/95 backdrop-blur border-t border-gray-200 pb-[env(safe-area-inset-bottom)] shadow-[0_-4px_12px_rgba(0,0,0,0.06)]">
