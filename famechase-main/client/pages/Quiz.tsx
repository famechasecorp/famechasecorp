  ...
  hindi: {
    ...
    options: {
      ...
      challenges: [
        ...
        "🥵 क्रिएटर वेलने��: बर्नआउट और कंटे��ट थकान",
          ...
          <div className="bg-white border-2 border-gray-100 rounded-2xl px-4 md:px-8 pt-3 md:pt-6 pb-20 md:pb-28 shadow-xl backdrop-blur-sm min-h-[70vh] flex flex-col gap-3">
            ...
            {!isGenerating && (
              <>
                ...
                <div className="fixed left-0 right-0 bottom-0 z-40 bg-white/95 backdrop-blur border-t border-gray-200 pb-[env(safe-area-inset-bottom)]">
